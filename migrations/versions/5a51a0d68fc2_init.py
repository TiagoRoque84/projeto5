...
Revision ID: 5a51a0d68fc2
Revises: 
Create Date: 2025-08-09 14:51:04.259298
...
def upgrade():
    ...
    sa.Column('alert_whatsapp', sa.String(length=50), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('reservista', sa.String(length=30), nullable=True),
    sa.Column('pis_pasep', sa.String(length=20), nullable=True),
    sa.Column('ctps', sa.String(length=30), nullable=True),
    sa.Column('cep', sa.String(length=10), nullable=True),
    sa.Column('logradouro', sa.String(length=200), nullable=True),
    sa.Column('numero', sa.String(length=20), nullable=True),
    sa.Column('complemento', sa.String(length=100), nullable=True),
    ...
    sa.Column('aso_data', sa.Date(), nullable=True),
    sa.Column('aso_tipo', sa.String(length=30), nullable=True),
    sa.Column('aso_arquivo_path', sa.String(length=255), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['company_id'], ['company.id'], ),
    sa.ForeignKeyConstraint(['funcao_id'], ['function.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
